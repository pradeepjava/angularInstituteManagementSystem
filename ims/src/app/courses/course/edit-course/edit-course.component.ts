...
export class EditCourseComponent implements OnInit {
  ...
  onSubmit(form: NgForm) {
    if (form.valid) {
      this.spinn = true;
      let courseDetailsToUpdate = new CourseDetails(this.courseDetails.courseId, form.value.courseName, form.value.courseFee, form.value.status, this.courseDetails.approveStatus)
